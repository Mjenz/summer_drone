...
MEMORY
    ...
    RAM (wx) : ORIGIN = 0x20200000, LENGTH = (768 * 1K)
    ITCM : ORIGIN = 0, LENGTH = 131072 DTCM : ORIGIN = 536870912, LENGTH = 131072 OCRAM : ORIGIN = 538968064, LENGTH = 786432
...
{
 . = ALIGN(_region_min_align); . = ALIGN( 1 << ((((_nocache_ram_size) <= 4) ? 2 : (((_nocache_ram_size) <= 8) ? 3 : (((_nocache_ram_size) <= 16) ? 4 : (((_nocache_ram_size) <= 32) ? 5 : (((_nocache_ram_size) <= 64) ? 6 : (((_nocache_ram_size) <= 128) ? 7 : (((_nocache_ram_size) <= 256) ? 8 : (((_nocache_ram_size) <= 512) ? 9 : (((_nocache_ram_size) <= 1024) ? 10 : (((_nocache_ram_size) <= 2048) ? 11 : (((_nocache_ram_size) <= 4096) ? 12 : (((_nocache_ram_size) <= 8192) ? 13 : (((_nocache_ram_size) <= 16384) ? 14 : (((_nocache_ram_size) <= 32768) ? 15:(((_nocache_ram_size) <= 65536) ? 16 : (((_nocache_ram_size) <= 131072) ? 17 : (((_nocache_ram_size) <= 262144) ? 18:(((_nocache_ram_size) <= 524288) ? 19 : (((_nocache_ram_size) <= 1048576) ? 20 : (((_nocache_ram_size) <= 2097152) ? 21 : (((_nocache_ram_size) <= 4194304) ? 22 : (((_nocache_ram_size) <= 8388608) ? 23 : (((_nocache_ram_size) <= 16777216) ? 24 : (((_nocache_ram_size) <= 33554432) ? 25 : (((_nocache_ram_size) <= 67108864) ? 26 : (((_nocache_ram_size) <= 134217728) ? 27 : (((_nocache_ram_size) <= 268435456) ? 28 : (((_nocache_ram_size) <= 536870912) ? 29 : (((_nocache_ram_size) <= 1073741824) ? 30 : (((_nocache_ram_size) <= 2147483648) ? 31 : 32))))))))))))))))))))))))))))))));
 _nocache_ram_start = .;
 *(.nocache)
 *(".nocache.*")
. = ALIGN(4);
 ...
 *(".kernel_noinit.*")
    ...
    _image_ram_end = .;
    _end = .;
    __kernel_ram_end = 0x20200000 + (768 * 1K);
